...
var valid_1 = __importDefault(require("semver/functions/valid"));
var path = __importStar(require("path"));
var webpack_1 = __importDefault(require("webpack"));
var utils_1 = __importDefault(require("./lib/utils"));
var get_typescript_1 = require("./lib/get-typescript");
...
var getTsLoaderIfExists = function (rules) {
    ...
    rules.some(function (rule) {
        ...
        if (lodash_1.default.isObject(rule.use) && rule.use.loader && rule.use.loader.match(/(^|[^a-zA-Z])ts-loader([^a-zA-Z]|$)/)) {
            /**
             * If the rule is found, it will look like this:
             * rules: [
             *  {
    ...
    return function (file) {
        ...
        var webpackOptions = lodash_1.default
            ...
            try {
                ...
                var tsVersion = (0, get_typescript_1.getResolvedTypescriptVersion)(options.typescript);
                var isTypescriptBelow6 = Boolean(tsVersion && (0, valid_1.default)(tsVersion) && (0, lt_1.default)(tsVersion, '6.0.0-0'));
                debug("ts-loader detected: overriding tsconfig to use sourceMap:true, inlineSourceMap:false, inlineSources:false".concat(isTypescriptBelow6
                    ? ', downlevelIteration:true'
                    : '', " (TypeScript ").concat(tsVersion !== null && tsVersion !== void 0 ? tsVersion : 'version unknown', ")"));
...
preprocessor.getResolvedTypescriptVersion = get_typescript_1.getResolvedTypescriptVersion;
